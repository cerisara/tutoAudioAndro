...
if [ -e maclef.key ]; then
  ...
  keytool -genkey -noprompt -storepass tototo -keypass tototo -keystore maclef.key -alias toto -dname "CN=example.com, OU=ID, O=example, L=Toto, S=tutu, C=FR" -validity 10000
